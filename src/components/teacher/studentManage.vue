...
<template>
  <div class="all">
    <el-table :data="pagination.list" border>
      ...
      <el-table-column prop="studentClass" label="班级" width="100"></el-table-column>
      <el-table-column prop="sex" label="性别" width="120"></el-table-column>
      <el-table-column prop="tel" label="联系方式" width="120"></el-table-column>
      <el-table-column fixed="right" label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="selectStudent(scope.row.id)" type="primary" size="small">编辑</el-button>
      ...
      <section class="update">
        <el-form ref="form" :model="form" label-width="80px">
          ...
          <el-form-item label="年级">
            <el-input v-model="form.studentGrade"></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    methods: {
      //分页查询学生信息
      getStudentInfo() {
        this.$axios.get(`apis/student/${this.pagination.pageNum}/${this.pagination.pageSize}`).then(res => {
      ...
      selectStudent(id) {
        ...
        this.$axios(`/api/student/${id}`).then(res => {
